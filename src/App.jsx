  ...
  return (
    ...
    <div className="tentang mt-32 py-10">
      ...
      <div className="tools mt-32">
        ...
        <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:3/4 w-full text-base/loose opacity-50">Berikut ini beberapa tools yang biasa saya pakai untuk pembuatan website</p>
    ...
    <div className="kontak mt-32 sm:p-10 p-0">
      ...
      <form action="https://formsubmit.co/akunprib070208@gmail.com" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off">
